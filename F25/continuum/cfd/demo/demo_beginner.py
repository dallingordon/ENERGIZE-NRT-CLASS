...
def fem_step(T_old):
    ...
    b = # TO-DO @ # TO-DO              # Compute right-hand side M T_old, @ means matrix multiplcation
    ...
    T_new = # TO-DO     # Solve sparse linear system
...
def fvm_step(T_old):
    ...
    T_new = # TO-DO  # Solve linear system for new temperature
